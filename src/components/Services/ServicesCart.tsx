...
const ServicesCart = (props: CartProps) => {
  return (
    <div className="flex font-[font-1] p-3">
      <div className="w-full flex flex-col items-center text-black bg-white font-bold rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 p-6"> 
