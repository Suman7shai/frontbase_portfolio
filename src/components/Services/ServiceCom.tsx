    ...
    return (
        <section className="font-[font-1]">
            <div className="text-white bg-gray-950  min-h-screen w-screen font-[font-1] flex flex-col items-center ">
                <Navigation />
                <div className="gap-2 w-full max-w-5xl px-4 flex flex-col items-center py-12 mt-20 animate">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#69c8ff] mb-5 mt-10 text-center">Our Services</h1>
                    <p className="text-base sm:text-lg pt-6 leading-8 sm:leading-10 mt-3 text-center px-2">
                ...
                <div className="w-full max-w-6xl px-4 mt-10 animate">
